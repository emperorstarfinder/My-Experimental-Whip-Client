...
namespace whipstress
{
    class CrossServerThreadTest
    {
        ...
        public CrossServerThreadTest(RemoteServer server1, RemoteServer server2)
        {
            _server1 = server1;
            _server2 = server2;
        ...
        public void Start()
        {
            Console.WriteLine("Starting 50 test threads");
            Thread t;
